  ...
  const content = (
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 sm:p-6 space-y-4 flex-shrink-0">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            <div className="flex-1 min-w-0">
              <h3 
                className="text-lg sm:text-xl font-bold text-white transition-colors group-hover:text-emerald-400 cursor-pointer hover:underline"
        ...
        {/* Content Section */}
        <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4 flex-1 flex flex-col min-h-0">
          <div className="min-h-[100px] overflow-hidden">
            <p className="text-sm sm:text-base text-white/80 leading-relaxed line-clamp-4" style={{ lineHeight: '1.25rem', margin: 0 }}>
              {description}
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 flex-shrink-0">
            ...
            {technologies.filter(tech => tech !== category).length > 4 && (
              <Badge variant="secondary" className="text-xs sm:text-sm bg-white/10 border-white/20 text-white">
        ...
        <div className="p-4 sm:p-6 pt-0 mt-auto space-y-4 flex-shrink-0">
